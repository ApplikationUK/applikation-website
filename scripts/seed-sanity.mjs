...
async function seed() {
  ...
  await upsert({
    ...
    logoCarousel: [
      { _key: key(), name: 'Annabel Karmel' },
      { _key: key(), name: 'ProvaRISK' },
      { _key: key(), name: 'Total Active Hub' },
      { _key: key(), name: 'Bioscore' },
      { _key: key(), name: 'Locus Security' },
      { _key: key(), name: 'Wellspace' },
      { _key: key(), name: 'Value for Venues' },
      { _key: key(), name: 'Optimise Your Marketing' },
      { _key: key(), name: 'Chlikk' },
      { _key: key(), name: 'Pocket Inspector' },
      { _key: key(), name: 'Olivier Mythodrama' },
      { _key: key(), name: 'Karmel & Co' },
    ],
    navLinks: [
